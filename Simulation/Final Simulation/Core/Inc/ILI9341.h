...
#define COLOR_REDDISH	0x4257A1 //0x4E71ED //0x3854B7
#define COLOR_GREEN		0x00FF00
#define COLOR_BLUE		0xFF0000
#define COLOR_YELLOW	0x00FFFF
#define COLOR_GREENS	(uint32_t[]) { 0x79C398, 0x6CAD58, 0x5C8F4D, 0x4E6B45, 0x88AD7D, 0xA0C295, 0x415C39, 0x346B4C, 0x4B70FB, 0x6FC9C9 }
#define COLOR_BROWNS	(uint32_t[]) { 0x39515C, 0x70909E, 0x237CA6, 0x48A7D4, 0x8ECFED }
#define COLOR_M_YELLOW	0x7BC0E5 //0x60D8E6 //0x4EB6C2 //0x56C9D6 //0x91B3D1 //0x48B6C2
#define COLOR_GRAYS		(uint32_t[]) { 0x342C28, 0x8C8C85, 0x6C7373, 0x414545, 0x5E6374, 0xA39B9C, 0xA8A8A8, 0x475454, 0xBDC7C7, 0x9DA6A6 }
